...
class LoRaRadioClass{
  ...
  public:
    ...
    // --- MY NEW ADDITIONS --- FOR USING THE LORA.H LIBRARY 

    void senddata(const char *Data, const uint8_t Data_Length);
    void sendpacket(unsigned char *buffer, unsigned char size);
