...
void LoRaRadioClass::reset() {
   ...
   //TODO: really required => should be tested
   // _delay_cycles(5);
...
// ALL THESE ARE MY NEW FUNCTIONALITIES TO WORK WITH THE LORA.H LIBRARY



void LoRaRadioClass::senddata(const char *Data, const uint8_t Data_Length){
 ...
 //make a copy of Data
  ...
  // Set Current package length
   ...
   sendpacket(tmpData, LORA_Package_Length);
...
void LoRaRadioClass::sendpacket(unsigned char *buffer, unsigned char size){
